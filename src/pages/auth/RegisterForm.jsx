...
const RegisterForm = () => {
    ...
    return (
        <div className="min-h-screen bg-gray-100 text-gray-900 flex justify-center items-center p-4">
            <div className="w-full max-w-md bg-white shadow sm:rounded-lg p-6 mx-4">
                <div className="flex flex-col items-center">
                    ...
                    <div className="w-full flex-1 mt-8">
                            ...
                            >
                                ...
                                >
                                    <path
                                        ...
                                        d="M16.5 10.5L21 15m0 0l-4.5 4.5M21 15H3"
                                    />
                                </svg>
                        ...
                        <GoogleAuthButton type="signup" onSuccess={() => navigate('/')} />
                    </div>
                </div>
            </div>
        </div>
